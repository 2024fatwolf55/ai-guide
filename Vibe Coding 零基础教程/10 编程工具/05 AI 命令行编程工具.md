...
除了访问限制之外，Claude Code 还有大规模封号的历史，而且它在客户端里藏了一套隐蔽的用户标记系统来识别中国用户，想搞清楚原理和风险的同学可以阅读本板块「Claude Code」目录中的《Claude Code 封号机制和应对方案》。
...
如果你想看 Cursor、Claude Code、Codex 等多款主流工具的完整视频教程，并且用它们从 0 做出多个完整项目，可以看看鱼皮的[《小白都能学的 AI 编程实战》视频课](https://ai.codefather.cn/course/2087008226460565505)，每个项目都是从需求分析到部署上线的全流程实战。
