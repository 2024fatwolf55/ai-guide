...
如果你想跟着视频系统学习 Cursor 和多款 AI 编程工具的使用，并用 AI 从 0 做出多个完整的企业级项目，可以看看鱼皮最新上线的 [《小白都能学的 AI 编程实战》视频课](https://ai.codefather.cn/course/2087008226460565505)，有更完整的 Cursor 保姆级视频教程 + 多套企业级项目实战教程，手把手带你系统学习。
