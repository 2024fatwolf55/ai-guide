...
还有《用 grill-me 让 AI 拷问你的需求》，介绍了一个只有几句话、但安装量排到全网前 3 的神级 Skill，教你在写代码之前先把需求想清楚。

**大厂 AI 编程经验**（`大厂 AI 编程经验/` 目录）：

这个目录专门收录大厂官方公开的 AI 编程方法论，都是他们在真实业务中踩过坑之后总结出来的经验，参考价值很高。目前收录了 3 篇 Anthropic 官方的分享：

- 《Anthropic 官方 - 提示词精简方法》：官方为什么把 Claude Code 的系统提示词砍掉了 80% 却不影响效果，以及我们自己该怎么给规则做减法。这篇和《用 grill-me 让 AI 拷问你的需求》正好是一组，一个讲少写什么，一个讲怎么把该说的说清楚。
- 《Anthropic 官方 - 大规模代码迁移方法》：官方的六步迁移法，教你用 AI 高效完成大规模代码迁移，百万行代码的项目也能扛得住。
- 《Anthropic 官方 - 人机协作团队方法》：讲的不是怎么写代码，而是怎么把 AI 当成同事来带，包括协作信息怎么写清楚、人和 AI 怎么分工、怎么用「北极星目标」让 AI 主动提建议、怎么循序渐进地建立信任。如果你所在的团队已经开始引入 AI 员工，建议和《11 Vibe Coding 团队协作技巧》搭配着看。
...
如果你想获得更完整的方法论总结，鱼皮的 [《小白都能学的 AI 编程实战》视频课](https://ai.codefather.cn/course/2087008226460565505)中配套了《AI 编程经验技巧大全》手册，系统讲解了五大核心心法、需求拆解四步法、Bug 三步排查法等实战方法论，而且在专属学员群里遇到任何问题都可以直接问我。
