...
Anthropic 把背后的原因总结成了一个概念，叫 **注意力预算**。模型的注意力总量是有限的，你给它的规则越多，它花在权衡这些规则上的注意力就越多，留给真正干活的注意力就越少。所以「简洁」不只是省 tokens，更是省注意力。想了解官方怎么用这个思路把 Claude Code 的系统提示词砍掉 80% 的，可以阅读本板块「大厂 AI 编程经验」目录中的《Anthropic 官方 - 提示词精简方法》。
