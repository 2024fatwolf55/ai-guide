...
💡 If you want to learn Git and GitHub in depth, check out my [Git & GitHub Beginner's Learning Path](https://www.codefather.cn/course/1789189862986850306/section/1789190804671012866). It’s completely free.

### 6. Make Good Use of the Terminal

AI code editors all come with a built-in terminal, so you can run commands directly. That means you don’t need to switch to other windows—you can complete all your work inside the editor.

For example, some common frontend development commands:
...
Cursor also supports generating commands directly in the terminal:

![](https://pic.yupi.icu/1/image-20260107141312489.png)

No need to memorize these commands! If you’re using Agent mode, the AI may even execute them automatically, so you don’t have to type them yourself.

### 7. Learn from the Generated Code

Using an AI code editor is also a great learning opportunity. The code AI generates may use technologies and libraries you’re unfamiliar with—and that’s exactly the right moment to learn.

So don’t just stop after letting AI generate the code. Try to understand it. If there’s something you don’t understand, ask AI directly: “What does this code mean?”

You can also try modifying the code and see what happens. That way, you won’t just finish the project—you’ll also learn real programming knowledge and gradually grow into a professional programmer (the Vibe Coding version).

## Final Words

At this point, I believe you now have a comprehensive understanding of AI code editors.

**AI code editors are the key step from “being able to use AI” to “doing professional development.”**

They let you control code more flexibly, handle more complex projects, learn more professional development practices, and accumulate real programming ability.

My advice is: don’t be intimidated by the complexity of the tools. Be bold and give them a try. Download Cursor or another AI code editor right away, and try rebuilding a project you previously made on a no-code platform using an AI code editor. It may feel a little unfamiliar at first, but you’ll quickly realize how powerful it is.

In the next article, I’ll introduce command-line tools and take you into a more advanced, more geeky style of Vibe Coding.
