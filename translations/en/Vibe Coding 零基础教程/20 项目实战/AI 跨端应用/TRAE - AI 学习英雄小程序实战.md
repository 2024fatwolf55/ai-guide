...
Reference style: Vibrant orange as the primary color, a fresh and soothing cartoon style, minimalist and elegant, giving people a relaxed and pleasant feeling.
```
...
You can adjust as needed, or just let the AI handle it freely.

I recommend committing your code after every optimization or new feature, and appropriately opening a new AI conversation to prevent too much context from affecting generation accuracy.

In the end, what you see in this mini program is the polished result—not bad, right?

![](https://pic.yupi.icu/1/image-20250928230316272.png)

However, since it's stuck in the certification and filing process (already in progress), it'll be a while before everyone can experience the mini program.

![](https://pic.yupi.icu/1/%E5%A4%87%E6%A1%88.png)

## Summary

Finally, let's talk about my experience developing this project with TRAE SOLO.

First, I felt the evolution of AI coding tools—SOLO has evolved from **integrating AI into tools, to integrating development tools into AI**.

![](https://pic.yupi.icu/1/image-20250928220158367.png)

It feels like the development tools are just playthings for the AI—it can freely operate editors, terminals, browsers, documentation, integrated services, and more to autonomously complete tasks. It's indeed more efficient and intelligent than before, and it can complete full projects including the backend. Plus, the AI follows enterprise-standard development workflows, automatically fixes most issues, and checks whether the project can run—unlike before, when generated code often couldn't run at all.

But during development, keep in mind that **AI really likes to overcomplicate simple things**, so it's best to manually double-check requirement documents and design documents, and complete development step by step like building with blocks.

I'll share more AI coding tips with everyone later—after all, AI is just a tool, and only when used correctly can it deliver its maximum value.

## Recommended Resources

1) Yupi's AI Navigation website: [Comprehensive AI resources, latest AI news, free AI tutorials](https://ai.codefather.cn)

2) Programming Navigation Learning Community: [Learning paths, programming tutorials, hands-on projects, job-hunting guide, Q&A](https://www.codefather.cn)

3) Programmer Interview Cheat Sheet: [High-frequency interview questions for internships/campus recruitment/social recruitment, real enterprise question analysis](https://www.mianshiya.com)

4) Programmer Resume Builder Tool: [Professional templates, rich example sentences, direct path to interviews](https://www.laoyujianli.com)

5) 1-on-1 Mock Interviews: [Essential for landing offers in internship/campus/social recruitment interviews](https://ai.mianshiya.com)