...
Building a solid observability system really comes down to solving 4 core problems:

1. What should be measured? You need to determine which key metrics matter most.
2. How should it be collected? Through automated tools or manual instrumentation.
3. How should it be stored? Choose a suitable way to preserve monitoring data.
4. How should it be displayed? Present it visually through charts and dashboards.

![](https://pic.yupi.icu/1/1753333524767-c89b8d1b-bc57-4094-ace7-1b37876f3f0b-20250821100951295.png)

Generally speaking, monitoring data can be divided into several layers:

- System metrics: CPU usage, memory usage, network traffic, etc. — focusing on "Can the machine still handle it?"
- Application metrics: API response time, error rate, request volume, etc. — focusing on "Is the application running smoothly?"
- Business metrics: user activity, order volume, AI invocation count, etc. — focusing on "How is the business performing?"

Optimizing system observability yourself is quite complex, requiring consideration of data collection, storage, analysis, alert mechanisms, availability guarantees, performance, and more. Large companies typically have dedicated infrastructure teams for this.
...
Its alert rule configuration is also very flexible. You can set rules based on different conditions, such as API response time exceeding a threshold, an excessively high error rate, or slow database queries. Once triggered, it automatically notifies you:
...
### 5. Professional Monitoring Dashboards

If you want a more professional monitoring experience, you can use the golden combination of Prometheus + Grafana. Prometheus is responsible for collecting and storing monitoring data, while Grafana turns the data into beautiful charts.

This combination is currently the most mainstream open-source monitoring solution. Once set up, it can produce extremely cool monitoring dashboard effects:

![](https://pic.yupi.icu/1/1755099021246-329ed3d8-b29c-4511-9cb1-0023058a933f.png)

With a dashboard like this, you can see the changing trends of all system metrics in real time at a glance.

I previously recorded a complete hands-on video showing how to build an ARMS + Prometheus + Grafana monitoring system from scratch. If you’re interested, take a look:

> Video tutorial: https://bilibili.com/video/BV1QPYDztEtW

If you want the full project tutorial and source code, you can visit [Programming Navigation’s "AI No-Code Application Generation Platform Project Tutorial"](https://www.codefather.cn/course/1948291549923344386).



## Final Words

The earlier you set up monitoring and alerting, the better. Don’t wait until your system runs into a major issue and regret not integrating it sooner. Spending a bit of time configuring monitoring upfront can save you a huge amount of troubleshooting effort later.

Come on — keep your system running healthy and strong!
