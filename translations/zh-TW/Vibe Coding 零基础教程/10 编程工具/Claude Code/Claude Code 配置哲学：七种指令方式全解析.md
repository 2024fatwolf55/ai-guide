...
順便說個能佐證這套設計的事：Anthropic 自己在新模型釋出後，把 Claude Code 的系統提示詞砍掉了 80% 以上，而程式設計跑分一點沒掉。他們砍掉的正是那些本該交給模型自己判斷、或者本該做成按需載入的內容。想了解這套「提示詞減法」的具體做法，可以閱讀本教程經驗技巧板塊中的《Anthropic 官方的提示詞精簡方法》。
