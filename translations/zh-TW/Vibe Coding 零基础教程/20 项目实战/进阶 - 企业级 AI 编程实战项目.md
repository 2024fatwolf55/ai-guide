...
基於 Taro 4 + Python FastAPI + LangChain + LangGraph + DeepSeek 開發的微信小程式，使用者輸入想學的知識，AI 自動聯網搜尋出題，邊闖關邊講解，答完給出覆盤報告。以 Vibe Coding 為核心，全程使用 GitHub Copilot + Claude Code 進行 AI 程式設計。實戰 Taro 跨端小程式框架、DeepSeek 大模型出題、Tavily 聯網搜尋 Agent、Chroma 向量庫 RAG 知識庫、AI 生圖 + 騰訊雲 COS 物件儲存，用 OpenSpec 規範驅動開發 + Harness Engineering 駕馭 AI 程式設計流程，最後走完小程式備案、稽核和釋出上線。

適合人群：想學 AI 程式設計做小程式產品並實現商業變現、掌握 Python + AI 應用開發全流程的同學，零基礎也能跟著做。

[👉🏻 點選開始學習](https://www.codefather.cn/course/2037104890135748610)

技術亮點：

- GitHub Copilot + Claude Code AI 程式設計
- MCP 外掛（Firecrawl + Context7 + Playwright）
- Agent Skills 能力擴充套件
- OpenSpec 規範驅動開發
- Taro 4 跨端小程式框架
...
![魚皮 AI 闖關學習小程式專案](https://pic.yupi.icu/1/1-project-demo-overview.png)
