...
Anthropic 把背後的原因總結成了一個概念，叫 **注意力預算**。模型的注意力總量是有限的，你給它的規則越多，它花在權衡這些規則上的注意力就越多，留給真正幹活的注意力就越少。所以「簡潔」不只是省 tokens，更是省注意力。想了解官方怎麼用這個思路把 Claude Code 的系統提示詞砍掉 80% 的，可以閱讀本板塊中的《Anthropic 官方的提示詞精簡方法》。
